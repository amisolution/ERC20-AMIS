...
// https://amisolution.github.io/ERC20-AMIS/contracts/amisdex/amis-exchange/DexOrderBookERC20EthV1p1y.sol on-chain continuous limit order book matching engine.
// This variation is for a "nice" ERC20 token as base, ETH as quoted, and standard fees with reward token.
// Copyright (c) amisolution. All Rights Reserved.
...
// 
//
contract DexOrderBookERC20EthV1p1y {
  ...
  //
  function DexOrderBookERC20EthV1p1y() {
