...
// amisolution.github.io/ERC20-AMIS on-chain continuous limit order book matching engine.
...
contract BookERC20EthV1Jul {
  ...
  // the reward token that can be used to pay fees (ZRX)
