...
var contractAddress = '0xEB5d54Cb6cB56B99C7784A5f77Cb15df95c55F05';
var contractInstance = OneStopAirdrop.at(contractAddress);

var etherscanTxUrl = "https://blockscout.com/etc/mainnet/tx/0xfd6c9bb205c393c650fba177d96f0f60d1bb3d6e9ebcb465ed4fd18f68551faa";
var etherscanUrl = "https://blockscout.com/etc/mainnet/address/0xEB5d54Cb6cB56B99C7784A5f77Cb15df95c55F05/contracts";
...
web3.version.getNetwork((err, netId) => {
    switch (netId) {
        ...
        break;
	case "61":
        $('#network').text("ETC Mainnet");
        contractAddress = '0xEB5d54Cb6cB56B99C7784A5f77Cb15df95c55F05';
        break;	    
        default:
...
function withdrawEth() {
    ...
    contractInstance.withdrawEth(ETH * (10 ** 18), {from: web3.eth.accounts[0], gasPrice: safeLowGasPrice * (10 ** 9)}, ((error, result) => {
        if(!error) {
            console.log("ETH/ETC WITHDRAWN: " + balance);
        } else {
            console.log("FAILED TO WITHDRAW ETH/ETC");
        }
    }))
}
...
function getEthBalance() {
    contractInstance.getEthBalanceOf(web3.eth.accounts[0], ((error, result) => {
        if(!error) {
            ...
            console.log("FAILED TO GET ETH/ETC BALANCE");
        }
    }))
}
